              ...
              <div class="tab-content" id="chat-options-tabContent"> 
                ...
                <div class="tab-pane fade" id="contacts" role="tabpanel" aria-labelledby="contacts-tab">
                  ...
                  <div class="search-contacts">
                    ...
                    <svg> 
                      <use href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#stroke-search"></use>
                  ...
                  <div class="dropdown-form dropdown-toggle" role="main" data-bs-toggle="dropdown" aria-expanded="false"><i class="icon-plus"></i>
                    <div class="chat-icon dropdown-menu dropdown-menu-start">
                      <div class="dropdown-item mb-2">
                        <svg> 
                          <use href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#camera"></use>
                        </svg>
                      </div>
                      <div class="dropdown-item">
                        <svg> 
                          <use href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#attchment"></use>
                        </svg>
                      </div>
                    </div>
                  </div>

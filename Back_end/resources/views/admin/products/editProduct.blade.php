            ...
            <div class="card-wrapper border rounded-3">
              ...
              <div id="imagediv" >
                ...
                <div class="container" class="d-flex">
                  <div class="col-3">
                    <img id="image" src="{{Storage::url($amge->image_link)}}" id="imagevariant" width="120px" height="120px" alt="">
                  </div>
                  <div class="mb-3">
                    <input class="form-control" id="image_product" name="images[]" type="file" accept="image/*">
              ...
              <div class="d-flex justify-content-center align-items-center">
                <div id="button" onclick="previewimage(this,0)" class="btn btn-secondary mx-auto">thêm ảnh</div>
              </div>
            </div>
          </div>
        </div>

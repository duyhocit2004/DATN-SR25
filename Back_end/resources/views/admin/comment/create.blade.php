...
@section('main')
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="">
                    <h2 class="mt-4">Thêm Bình Luận</h2>
                </div>
                <div class="card-body basic-form">
                    <div class="card-wrapper border rounded-3">
                        <form class="row" action="{{ route('comments.store') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="products_id" name="products_id">
                                    ...
                                    @foreach ($product as $product)
                                        <option value="{{ $product->id }}" {{ old('products_id') }}>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="user_id" name="user_id">
                                    <option disabled selected>-- Tài khoản --</option>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="content" name="content" rows="3" placeholder="Nhập nội dung bình luận...">{{ old('content') }}</textarea>
                                @error('content')
                                    <p style="color: red">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="rating" name="rating">
                                    <option value="" {{ old('rating') ? '' : 'selected' }}>Chọn đánh giá</option>

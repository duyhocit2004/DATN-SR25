...
<!-- iconly-icon-->
<link rel="stylesheet" href="{{asset('admin/css/iconly-icon.css')}}"/>
<link rel="stylesheet" href="{{asset('admin/css/bulk-style.css')}}"/>
<!-- iconly-icon-->
<link rel="stylesheet" href="{{asset('admin/css/themify.css')}}"/>
<!--fontawesome-->
<link rel="stylesheet" href="{{asset('admin/css/fontawesome-min.css')}}"/>
<!-- Whether Icon css-->
<link rel="stylesheet" type="text/css" href="{{asset('admin/css/vendors/weather-icons/weather-icons.min.css')}}"/>

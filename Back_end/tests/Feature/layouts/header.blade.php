      ...
      <div class="nav-right">
        <ul class="header-right">
          ...
          <li><a class="full-screen" href="javascript:void(0)">
              <svg>
                <use href=""> <symbol id="scanfull" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" fill="none">
                    <path d="M1.5 6.75V5.25C1.5 3 3 1.5 5.25 1.5H12.75C15 1.5 16.5 3 16.5 5.25V6.75"
                          stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M1.5 11.25V12.75C1.5 15 3 16.5 5.25 16.5H12.75C15 16.5 16.5 15 16.5 12.75V11.25"
                          stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M1.5 9H16.5" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                </symbol></use>
              </svg></a></li>
          <li class="custom-dropdown"><a href="javascript:void(0)">
              <svg>

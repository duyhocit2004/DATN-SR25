  ...
  //       status: newFilterData.status.length > 0 ? newFilterData.status : null,
  //       paymentStatus: newFilterData.paymentStatus,
  //       paymentMethod: newFilterData.paymentMethod,
  //       fromDate: newFilterData.dateTime?.[0]
  //         ? dayjs(newFilterData.dateTime?.[0]).format(ISO8601DateFormatDayjs)
  //         : null,
  //       toDate: newFilterData.dateTime?.[1]
  //         ? dayjs(newFilterData.dateTime?.[1]).format(ISO8601DateFormatDayjs)
  //         : null,
  //     };
